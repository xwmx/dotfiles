...
# c.NotebookApp.notebook_dir = u'{0}/.ipython/profile_default'.format(os.environ.get('HOME'))
...
# c.Session.username = u'{0}'.format(os.environ.get('USER'))
...
# 
# c.MappingKernelManager.root_dir = u'{0}/.ipython/profile_default'.format(os.environ.get('HOME'))
...
# 
# c.FileNotebookManager.notebook_dir = u'{0}/.ipython/profile_default'.format(os.environ.get('HOME'))
