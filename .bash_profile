...
export GS_FONTPATH=/usr/lib/X11/fonts/Type1:/usr/lib/X11/fonts/TTF
...
#==========================================================================
# set textmate as editor for git
#==========================================================================
...
#==========================================================================
# IM IN UR GREP IGNORIN UR SVN
#==========================================================================

alias svngrep='grep --exclude=\*.svn\* -n'
